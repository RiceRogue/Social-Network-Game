...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] flex flex-col items-center justify-center p-10 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-xl flex flex-col gap-8">
        ...
        <div className="text-center">
          ...
          <p className="text-slate-500 text-xs tracking-[0.3em] uppercase">Identity Economy</p>
        </div>

        {/* Character select */}
        <div className="bg-[#12131a] border border-slate-800 rounded-2xl p-8 shadow-2xl flex flex-col gap-6">

          <div>
            <h2 className="text-white font-semibold text-base mb-1">Choose your identity</h2>
            <p className="text-slate-600 text-xs">Select a character to represent you in the network.</p>
          </div>
          ...
          <div className="grid grid-cols-5 gap-3">
            {HEAD_ICONS.map((icon) => (
              <button
                ...
                `}
                style={{ background: selected?.id === icon.id ? `${icon.color}15` : '#0d0e14' }}
              >
                <div
                ...
                <span className="text-[10px] font-medium tracking-wide" style={{ color: icon.color }}>
                  {icon.label}
                </span>
              </button>
            ))}
          ...
          {selected && (
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-slate-600 text-xs">Ready to join the network</p>
              </div>
              <div
        ...
        {/* Username */}
        <div className="bg-[#12131a] border border-slate-800 rounded-2xl p-8 shadow-2xl flex flex-col gap-4">
          <div>
            <h2 className="text-white font-semibold text-base mb-1">Set your username</h2>
            <p className="text-slate-600 text-xs">This is how others will see you.</p>
          </div>
        ...
        <p className="text-center text-slate-800 text-xs">
